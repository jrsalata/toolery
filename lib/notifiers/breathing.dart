...
class BreathingNotifier extends ChangeNotifier {
  ...
  /// [BreathingRepository.ready] one layer up.
  ///
  /// The initial load runs off-frame — SQLite I/O schedules no frames — so a
  /// widget test's `pumpAndSettle()` can report the tree settled while
  /// [breathings] is still empty. Awaiting this is the only way to know the
